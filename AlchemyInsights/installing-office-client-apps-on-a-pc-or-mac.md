...
Fordern Sie dann jeden Benutzer auf, folgende Schritte auszuführen:

1. Wechseln zur [Portalseite](https://portal.office.com/OLS/MySoftware.aspx).
2. Anmelden mit ihrem Geschäfts-, Uni- oder Schulkonto, dem eine Office-Lizenz zugewiesen ist. 
