...
4. Wählen Sie unten auf der Seite " **Speichern** " aus, und "contacts.csv" wird im Standardordner "Downloads" gespeichert. Um auszuwählen, wo die .csv Datei gespeichert werden soll, wählen Sie den Pfeil neben "Speichern" und dann " **Speichern unter**" aus.
