...
Sie können Dateien und Ordner aus OneDrive oder aus SharePoint Online mit nur wenigen Klicks auf Ihren Computer herunterladen. Weitere Informationen zum Herunterladen von Dateien, zur Geschwindigkeit und zum Einschränken von Downloads finden Sie unter den links unten.
...
- [Durchsuchen der Ereignisse "Heruntergeladene Datei" in Überwachungsprotokollen](https://docs.microsoft.com/microsoft-365/compliance/search-the-audit-log-in-security-and-compliance#file-and-page-activities) , um zu identifizieren, wer Dateien heruntergeladen hat
...
- [Beheben OneDrive Synchronisierungsprobleme](https://support.office.com/article/Fix-OneDrive-sync-problems-83ab0d8a-8400-45b0-8dcf-dc8aa8a6bcf8)
